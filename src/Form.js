...
export default function Form(props) {
  ...
  return (
    <div>
      <form id="DataEntryForm" onSubmit={submitData}>
      ...
      {showOutput && (
        <Output fullname={nameState}email={emailState}address={addressState}
          city={cityState}province={provinceState}postal={postalState}
